(function ()
{
    ...
    {
        $stateProvider.state('app.tasks-calendar', {
            url     : '/projects/:project_id/calendar',
            views   : {
                'content@app': {
                    templateUrl: 'app/main/agile/tasks-calendar/tasks-calendar.html',
                    controller: 'TasksCalendarController as vm'
                }
            },
